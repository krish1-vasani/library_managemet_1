...
urlpatterns = [
    ...
    path('books.html', views.api_books, name='api_books'),
    path('students.html', views.api_students, name='api_students'),
    path('issuedbooks.html', views.api_issuedbooks, name='api_issuedbooks'),
    path('myissuedbooks.html', views.api_myissuedbooks, name='api_myissuedbooks'),
